    ...
    <section className=" dark:bg-gray-100 text-black dark:text-gray-800">
      <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
        <a
          ...
          href="#"
          className=" rounded-lg block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12  dark:bg-gray-50 border-2 border-gray-200">
          <img src={firstBook.image} alt="" className="object-fit mx-auto h-64 rounded sm:h-96 lg:col-span-7 bg-gray-500 dark:bg-gray-500" />
          <div className="p-6 space-y-2 lg:col-span-5 mt-20">
            <h3 className="text-2xl font-semibold sm:text-4xl group-hover:underline group-focus:underline"></h3>
            <p className="text-4xl font-semibold">Books to freshen up</p>
            <p className="text-4xl font-semibold">your Bookshelf</p>
            <Link to="/listedbooks">
              <button className="btn btn-secondary my-10">View The List</button>
            </Link>
          </div>
        </a>
